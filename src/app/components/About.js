  ...
  return (
    ...
    >
      ...
      <article className="space-y-4">
        <p>
          I used to build <strong className="text-cyan-400">robots</strong>, now
          I build websites 🔨🤖➡️🌐. I've been freelancing for{" "}
          <strong className="text-cyan-400">3 years</strong> now, building and
        ...
        <div>
          <p>
            ...
            <strong className="text-cyan-400">Next.js</strong>. When I start
